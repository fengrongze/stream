...
@NoArgsConstructor
@ApiModel(value = "MileageYearTransfor",description = "mileage 年数据结果",parent = CSTData.class)
public class MileageYearTransfor extends CSTData {
