...
@NoArgsConstructor
@ApiModel(value = "AmDayLatestData",description = "am day latest data",parent = CSTData.class)
public class AmDayLatestData extends CSTData {
    ...
    @Builder
    public AmDayLatestData(String carId, Long time, Integer ignition, Integer flameOut, Integer insertNum, Integer collision, Integer overSpeed, Integer isMissing, Float pulloutTimes, Integer isFatigue, Integer pulloutCounts) {
        super(carId, time);
