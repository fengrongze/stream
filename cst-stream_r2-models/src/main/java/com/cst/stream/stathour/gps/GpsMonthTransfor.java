...
@NoArgsConstructor
@ApiModel(value = "GpsMonthTransfor",description = "gps 月数据结果",parent = CSTData.class)
public class GpsMonthTransfor extends CSTData {
    ...
    @Builder
    public GpsMonthTransfor(String carId, Long time, Integer maxSatelliteNum, Integer gpsCount, Integer nonLocalNum) {
        this.carId = carId;
        this.time = time;
