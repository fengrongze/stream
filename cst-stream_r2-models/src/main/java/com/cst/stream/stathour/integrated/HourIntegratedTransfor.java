...
/**
 * @author Johnney.Chiu
 * create on 2018/6/29 14:33
 * @Description 整合所有栏位的值
 * @title
 */
@Getter
@Setter
...
@NoArgsConstructor
@ApiModel(value = "HourIntegratedTransfor",description = "小时数据结果",parent = CSTData.class)
public class HourIntegratedTransfor extends CSTData{
    ...
    @Builder
    public HourIntegratedTransfor(String carId, Long time, Integer ignition, Integer flameOut, Integer insertNum, Integer collision, Integer overSpeed, Integer isMissing, Float pulloutTimes, Integer isFatigue, Integer rapidAccelerationCount, Integer rapidDecelerationCount, Integer sharpTurnCount, Integer maxSatelliteNum, Integer gpsCount, Integer dinChange, Integer isNonLocal, String din, Integer speed, Float totalDistance, Float totalFuel, Integer runTotalTime, Float motormeterDistance, Float maxSpeed, Integer isHighSpeed, Integer isDrive, Float mileage, Float fuel, Integer duration, Float fee, Integer traceCounts, Integer traceDeleteCounts, Float maxVoltage, Float minVoltage, Float fuelPerHundred, Float toolingProbability, Float averageSpeed, Integer pulloutCounts, Float powerConsumption, Double milGpsMileage, Double milObdMileage, Double milPanelMileage, Double milFuel, Integer milDuration, Double milFee, Float milObdMaxSpeed, Float milGpsMaxSpeed, Integer gpsSpeed, Integer obdSpeed, Double milGpsTotalDistance, Double milObdTotalDistance, Double milTotalFuel, Long milRunTotalTime, Double panelDistance) {
        super(carId, time);
