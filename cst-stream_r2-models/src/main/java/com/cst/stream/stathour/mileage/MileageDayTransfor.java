...
@NoArgsConstructor
@ApiModel(value = "MileageDayTransfor",description = "mileage 天数据结果",parent = CSTData.class)
public class MileageDayTransfor extends CSTData {
