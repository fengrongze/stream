...
@NoArgsConstructor
@ApiModel(value = "YearIntegratedTransfor",description = "年数据结果",parent = CSTData.class)
public class YearIntegratedTransfor extends CSTData{
