...
@NoArgsConstructor
@ApiModel(value = "DeHourLatestData",description = "de hour latest data",parent = CSTData.class)
public class DeHourLatestData extends CSTData {
    ...
    @Builder
    public DeHourLatestData(String carId, Long time, Float speed, Integer actType, Integer gatherType, Integer rapidAccelerationCounts, Integer rapidDecelerationCounts, Integer sharpTurnCounts) {
        super(carId, time);
        this.speed = speed;
