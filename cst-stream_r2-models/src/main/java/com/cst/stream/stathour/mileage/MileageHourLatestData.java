...
@NoArgsConstructor
@ApiModel(value = "MileageHourLatestData",description = "mileage 小时中间数据",parent = CSTData.class)
public class MileageHourLatestData extends CSTData {
    ...
    @Builder
    public MileageHourLatestData(String carId, Long time, Float milObdMaxSpeed, Float milGpsMaxSpeed, Integer gpsSpeed, Integer obdSpeed, Double milGpsTotalDistance, Double milObdTotalDistance, Double milTotalFuel, Long milRunTotalTime, Double panelDistance, Integer panelFlag) {
        super(carId, time);
