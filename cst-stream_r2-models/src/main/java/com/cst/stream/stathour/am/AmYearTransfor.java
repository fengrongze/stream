...
@NoArgsConstructor
@ApiModel(value = "AmYearTransfor",description = "am 年计算",parent = CSTData.class)
public class AmYearTransfor extends CSTData {
    ...
    @Builder
    public AmYearTransfor(String carId, Long time, Integer ignition, Integer flameOut, Integer insertNum, Integer collision, Integer overSpeed, Integer missingNum, Float pulloutTimes, Integer fatigueNum, Integer pulloutCounts) {
        super(carId, time);
