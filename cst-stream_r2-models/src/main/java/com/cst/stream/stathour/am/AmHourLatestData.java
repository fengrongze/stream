...
@NoArgsConstructor
@ApiModel(value = "AmHourLatestData",description = "am hour latest data ",parent = CSTData.class)
public class AmHourLatestData extends CSTData {
    ...
    public AmHourLatestData(String carId, Long time, Integer ignition, Integer flameOut, Integer insertNum, Integer collision, Integer overSpeed, Integer isMissing, Float pulloutTimes, Integer isFatigue, Integer pulloutCounts) {
        super(carId, time);
