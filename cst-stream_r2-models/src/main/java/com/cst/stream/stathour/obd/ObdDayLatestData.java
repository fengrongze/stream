...
@ApiModel(value = "ObdDayLatestData",description = "obd 年数据结果",parent = CSTData.class)
public class ObdDayLatestData extends CSTData{
    ...
    @Builder
    public ObdDayLatestData(String carId, Long time, String din, Integer speed, Float totalDistance, Float totalFuel, Integer runTotalTime, Float motormeterDistance, Float maxSpeed, Integer isHighSpeed, Integer isNightDrive, Integer isDrive, Integer dinChange, Float toolingProbability, Integer engineSpeed, Integer sameEngineSpeedCount) {
        super(carId, time);
        this.din = din;
        this.speed = speed;
