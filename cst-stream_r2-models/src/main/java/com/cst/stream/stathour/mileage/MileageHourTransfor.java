...
@NoArgsConstructor
@ApiModel(value = "MileageHourTransfor",description = "mileage 小时数据结果",parent = CSTData.class)
public class MileageHourTransfor extends CSTData {
