 ...
 * @Description voltage bolt
 * @title
 */
public class VoltageHourDataPersistBolt extends BaseBasicBolt {


    private static final long serialVersionUID = -7276475832859629103L;
    ...
    public VoltageHourDataPersistBolt(Properties prop, boolean forceLoad) {
        this.prop = prop;
    ...
    public void prepare(Map stormConf, TopologyContext context) {
        ...
        logger = LoggerFactory.getLogger(VoltageHourDataPersistBolt.class);
    ...
    public void execute(Tuple tuple, BasicOutputCollector collector) {
        ...
        if(!StreamKey.VoltageStream.VOLTAGE_HOUR_BOLT_S.equals(tuple.getSourceStreamId()))
            return;
        resultPersist(msg, StrategyChoose.generateStrategy(prop.getProperty(PropKey.DEAL_STRATEGY), httpUtils,
                ...
                connection, HBaseTable.HOUR_STATISTICS.getTableName(), HBaseTable.HOUR_STATISTICS.getSeventhFamilyName(),
                HbaseColumn.HourStatisticsCloumn.voltageHourColumns,
                VoltageHourTransfor.class), StreamTypeDefine.VOLTAGE_TYPE, CstConstants.TIME_SELECT.HOUR);
