 ...
 * @Description trace bolt
 * @title
 */
public class TraceHourDataPersistBolt extends BaseBasicBolt {


    private static final long serialVersionUID = -4189830786401667794L;
    ...
    public TraceHourDataPersistBolt(Properties prop, boolean forceLoad) {
        this.prop = prop;
    ...
    public void prepare(Map stormConf, TopologyContext context) {
        ...
        logger = LoggerFactory.getLogger(TraceHourDataPersistBolt.class);
    ...
    public void execute(Tuple tuple, BasicOutputCollector collector) {
        ...
        if(!StreamKey.TraceStream.TRACE_HOUR_BOLT_S.equals(tuple.getSourceStreamId()))
            return;
        resultPersist(msg, StrategyChoose.generateStrategy(prop.getProperty(PropKey.DEAL_STRATEGY), httpUtils,
                ...
                connection, HBaseTable.HOUR_STATISTICS.getTableName(), HBaseTable.HOUR_STATISTICS.getFifthFamilyName(),
                HbaseColumn.HourStatisticsCloumn.traceHourColumns,
                TraceHourTransfor.class), StreamTypeDefine.TRACE_TYPE, CstConstants.TIME_SELECT.HOUR);
