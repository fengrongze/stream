...
public class ElectricObdGdcp3Spout extends BaseRichSpout {
    ...
    public void nextTuple() {
        ...
        try {
            ...
            logger.error("gdcp3 electric obd consumer hour data error",e);
        }
    }
    ...
    private void initConsumer() {
        this.consumer = KafkaConsumerUtil.buildKafkaConsumer(prop, OtherKey.Gdcp3GroupTail.ELECTRIC_OBD_HOUR);
