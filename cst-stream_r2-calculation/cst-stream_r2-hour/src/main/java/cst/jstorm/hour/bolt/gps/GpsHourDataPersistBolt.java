 ...
 * @Description gps bolt
 * @title
 */
public class GpsHourDataPersistBolt  extends BaseBasicBolt {


    private static final long serialVersionUID = -4846181465369616532L;
    ...
    public GpsHourDataPersistBolt(Properties prop, boolean forceLoad) {
        this.prop = prop;
    ...
    public void prepare(Map stormConf, TopologyContext context) {
        ...
        logger = LoggerFactory.getLogger(GpsHourDataPersistBolt.class);
    ...
    public void execute(Tuple tuple, BasicOutputCollector collector) {
        ...
        if(!StreamKey.GpsStream.GPS_HOUR_BOLT_S.equals(tuple.getSourceStreamId()))
            return;
        resultPersist(msg, StrategyChoose.generateStrategy(prop.getProperty(PropKey.DEAL_STRATEGY), httpUtils,
                prop.getProperty("url_base"), HttpURIUtil.GPS_HOUR_SAVE,
                connection, HBaseTable.HOUR_STATISTICS.getTableName(), HBaseTable.HOUR_STATISTICS.getSecondFamilyName(),
                HbaseColumn.HourStatisticsCloumn.gpsHourColumns,
                GpsHourTransfor.class), StreamTypeDefine.GPS_TYPE, CstConstants.TIME_SELECT.HOUR);
