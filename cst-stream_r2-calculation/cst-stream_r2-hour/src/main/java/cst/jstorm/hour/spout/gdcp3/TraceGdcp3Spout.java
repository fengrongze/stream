...
public class TraceGdcp3Spout extends BaseRichSpout {
	...
	public void nextTuple() {
		...
		try {
			...
			logger.debug("gdcp3 trace topic deal time:{}", (System.currentTimeMillis() - start));
		}catch (Exception e){
		logger.error("gdcp3 trace hour consumer data error",e);
		}
	}
	...
	private void initConsumer() {
		this.consumer = KafkaConsumerUtil.buildKafkaConsumer(prop, OtherKey.Gdcp3GroupTail.TRACE_HOUR);
