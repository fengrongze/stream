...
public class TraceDeleteSpout extends BaseRichSpout {
	...
	public void nextTuple() {
		...
		try {
			...
			logger.error("trace delete hour consumer data error",e);
		}
	}
	...
	private void initConsumer() {
		this.consumer = KafkaConsumerUtil.buildStringKafkaConsumer(prop, OtherKey.GroupTail.TRACE_DELETE_HOUR);
