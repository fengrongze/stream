 ...
 * @Description trace delete day persist
 * @title
 */
public class TraceDeleteDayDataPersistBolt extends BaseBasicBolt {
    private static final long serialVersionUID = -8025300357388133497L;
    ...
    public TraceDeleteDayDataPersistBolt(Properties prop, boolean forceLoad) {
        this.prop = prop;
    ...
    public void prepare(Map stormConf, TopologyContext context) {
        ...
        logger = LoggerFactory.getLogger(TraceDeleteDayDataPersistBolt.class);
    ...
    public void execute(Tuple tuple, BasicOutputCollector collector) {
        ...
        resultPersist(msg, StrategyChoose.generateStrategy(prop.getProperty(PropKey.DEAL_STRATEGY), httpUtils,
                ...
                HBaseTable.DAY_STATISTICS.getSixthFamilyName(),
                HbaseColumn.DayStatisticsCloumn.traceDeleteDayColumns,
                TraceDeleteDayTransfor.class), StreamTypeDefine.TRACE_DELETE_TYPE, CstConstants.TIME_SELECT.DAY);
