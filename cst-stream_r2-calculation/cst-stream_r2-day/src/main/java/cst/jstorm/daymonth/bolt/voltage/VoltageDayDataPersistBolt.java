 ...
 * @Description voltage day persist
 * @title
 */
public class VoltageDayDataPersistBolt extends BaseBasicBolt {
    private static final long serialVersionUID = 932605373127317203L;
    ...
    public VoltageDayDataPersistBolt(Properties prop, boolean forceLoad) {
        this.prop = prop;
    ...
    public void prepare(Map stormConf, TopologyContext context) {
        ...
        logger = LoggerFactory.getLogger(VoltageDayDataPersistBolt.class);
    ...
    public void execute(Tuple tuple, BasicOutputCollector collector) {
        ...
        resultPersist(msg, StrategyChoose.generateStrategy(prop.getProperty(PropKey.DEAL_STRATEGY), httpUtils,
                ...
                HBaseTable.DAY_STATISTICS.getSeventhFamilyName(),
                HbaseColumn.DayStatisticsCloumn.voltageDayColumns,
                VoltageDayTransfor.class), StreamTypeDefine.VOLTAGE_TYPE,CstConstants.TIME_SELECT.DAY);
