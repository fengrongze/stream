 ...
 * @Description trace day persist
 * @title
 */
public class TraceDayDataPersistBolt extends BaseBasicBolt {
    private static final long serialVersionUID = -1966855232994668904L;
    ...
    public TraceDayDataPersistBolt(Properties prop, boolean forceLoad) {
        this.prop = prop;
    ...
    public void prepare(Map stormConf, TopologyContext context) {
        ...
        logger = LoggerFactory.getLogger(TraceDayDataPersistBolt.class);
    ...
    public void execute(Tuple tuple, BasicOutputCollector collector) {
        ...
        resultPersist(msg, StrategyChoose.generateStrategy(prop.getProperty(PropKey.DEAL_STRATEGY), httpUtils,
                ...
                HBaseTable.DAY_STATISTICS.getFifthFamilyName(),
                HbaseColumn.DayStatisticsCloumn.traceDayColumns,
                TraceDayTransfor.class), StreamTypeDefine.TRACE_TYPE, CstConstants.TIME_SELECT.DAY);
