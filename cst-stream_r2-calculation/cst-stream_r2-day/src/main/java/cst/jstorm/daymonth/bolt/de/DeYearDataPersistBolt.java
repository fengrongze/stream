 ...
 * @Description am year persist
 * @title
 */
public class DeYearDataPersistBolt extends BaseBasicBolt {
    ...
    public DeYearDataPersistBolt(Properties prop, boolean forceLoad) {
        this.prop = prop;
    ...
    public void prepare(Map stormConf, TopologyContext context) {
        ...
        logger = LoggerFactory.getLogger(DeYearDataPersistBolt.class);
    ...
    public void execute(Tuple tuple, BasicOutputCollector collector) {
        ...
        if (StringUtils.isBlank(msg))
            return;
        if(!StreamKey.DeStream.DE_YEAR_BOLT_S.equals(tuple.getSourceStreamId()))
            return;
        resultPersist(msg, StrategyChoose.generateStrategy(prop.getProperty(PropKey.DEAL_STRATEGY), httpUtils,
                prop.getProperty("url_base"), HttpURIUtil.DE_YEAR_SAVE,
                ...
                DeYearTransfor.class), StreamTypeDefine.DE_TYPE, CstConstants.TIME_SELECT.YEAR);
    }
