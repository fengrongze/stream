 ...
 * @Description trace month persist
 * @title
 */
public class TraceMonthDataPersistBolt extends BaseBasicBolt {
    ...
    public TraceMonthDataPersistBolt(Properties prop, boolean forceLoad) {
        this.prop = prop;
    ...
    public void prepare(Map stormConf, TopologyContext context) {
        ...
        logger = LoggerFactory.getLogger(TraceMonthDataPersistBolt.class);
    ...
    public void execute(Tuple tuple, BasicOutputCollector collector) {
        ...
        if (StringUtils.isBlank(msg))
            return;
        if(!StreamKey.TraceStream.TRACE_MONTH_BOLT_S.equals(tuple.getSourceStreamId()))
            return;
        resultPersist(msg, StrategyChoose.generateStrategy(prop.getProperty(PropKey.DEAL_STRATEGY), httpUtils,
                prop.getProperty("url_base"), HttpURIUtil.TRACE_MONTH_SAVE,
                ...
                TraceMonthTransfor.class), StreamTypeDefine.TRACE_TYPE, CstConstants.TIME_SELECT.MONTH);
    }
