 ...
 * @Description am day persist
 * @title
 */
public class AmDayDataPersistBolt extends BaseBasicBolt {
    private static final long serialVersionUID = -2168013360801357767L;
    ...
    public AmDayDataPersistBolt(Properties prop, boolean forceLoad) {
        this.prop = prop;
    ...
    public void prepare(Map stormConf, TopologyContext context) {
        ...
        logger = LoggerFactory.getLogger(AmDayDataPersistBolt.class);
    ...
    public void execute(Tuple tuple, BasicOutputCollector collector) {
        ...
        resultPersist(msg, StrategyChoose.generateStrategy(prop.getProperty(PropKey.DEAL_STRATEGY), httpUtils,
                ...
                HBaseTable.DAY_STATISTICS.getThirdFamilyName(),
                HbaseColumn.DayStatisticsCloumn.amDayColumns,
                AmDayTransfor.class), StreamTypeDefine.AM_TYPE, CstConstants.TIME_SELECT.DAY);

        //持久化完成,发送到后端处理
        //collector.emit(StreamKey.ObdStream.AM_DAY_PERSIST_S,new Values(msg,msgId, IntegrityDayCalcEnum.AM.getValue()));
    }

    @Override
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declareStream(StreamKey.ObdStream.AM_DAY_PERSIST_S, new Fields(new String[] {
